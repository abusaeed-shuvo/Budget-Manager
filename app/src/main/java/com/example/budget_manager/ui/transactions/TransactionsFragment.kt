...
class TransactionsFragment : Fragment(), TransactionAdapter.TransactionClicker {
	...
	override fun deleteTransaction(transaction: Transaction) {
		TransactionDatabase.getDB(requireContext()).getTransactionDao().deleteData(transaction)
		findNavController().navigate(R.id.action_transactionsFragment_to_homeFragment)
	}
}
